...
- I run a [personal website](https://valeriansaliou.name/), on which I sometimes blog, publish pictures and list books I have read.
- Oh, and last thing: I co-invented [MakAir](https://journal.valeriansaliou.name/makair-series-the-inception-of-an-open-source-ventilator-project/), the world's first open-source medical ventilator.
